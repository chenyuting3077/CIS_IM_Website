...
optimizer = dict(
    betas=(
        0.9,
        0.999,
    ), eps=1e-08, lr=6e-05, type='AdamW', weight_decay=0.01)
param_scheduler = [
    dict(begin=0, by_epoch=True, end=50, eta_min=0, power=1.0, type='PolyLR'),
]
resume = False
...
work_dir = './work_dirs\\mask2former_FocalNet_tiny_50_IM_Aug_focal_decoder_(correct)'
