...
class MMSegInferencer(BaseInferencer):
    ...
    Args:
        ...
        classes (list, optional): Input classes for result rendering, as the
            ...
            `IM` classes by default. Defaults to None.
        palette (list, optional): Input palette for result rendering, which is
            a list of color palette responding to the classes. If palette is
            not defined, visualizer will take `IM` palette by default.
            Defaults to None.
    ...
    def _load_weights_to_model(self, model: nn.Module,
        ...
        if checkpoint is not None:
            ...
            warnings.warn('Checkpoint is not loaded, and the inference '
                          ...
                          'model!')
            warnings.warn(
                'weights is None, use IM classes by default.')
            model.dataset_meta = {
                'classes': get_classes('IM'),
                'palette': get_palette('IM')
            }
