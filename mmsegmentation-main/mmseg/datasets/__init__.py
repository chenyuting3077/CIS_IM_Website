...
from .IMLarge import IMLargeDataset
from .IM_multi_class import IMMultiClass
# yapf: disable
...
from .stomach import StomachDataset
# yapf: enable
__all__ = [
    ...
    'NYUDataset', 'IMLargeDataset', 'StomachDataset', 'IMMultiClass'
]
