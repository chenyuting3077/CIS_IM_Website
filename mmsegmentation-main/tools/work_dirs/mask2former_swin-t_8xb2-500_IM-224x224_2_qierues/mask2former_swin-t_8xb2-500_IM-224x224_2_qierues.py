...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=True, interval=50, save_best='mIoU', type='CheckpointHook'),
...
launcher = 'none'
load_from = '../work_dirs/mask2former_swin-t_8xb2-500_IM-224x224_2_qierues/epoch_500.pth'
log_level = 'INFO'
...
optimizer = dict(
    ...
    weight_decay=0.05)
param_scheduler = [
    dict(begin=0, by_epoch=True, end=500, eta_min=0, power=0.9, type='PolyLR'),
]
...
train_cfg = dict(max_epochs=500, type='EpochBasedTrainLoop', val_interval=50)
...
work_dir = './work_dirs\\mask2former_swin-t_8xb2-500_IM-224x224_2_qierues'
